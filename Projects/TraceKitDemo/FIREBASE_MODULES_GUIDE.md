...
1. [개요](#개요)
2. [FirebaseAnalyticsTraceDestination](#1-firebaseanalyticstracedestination)
3. [FirebaseCrashlyticsTraceDestination](#2-firebasecrashlyticsTracedestination)
4. [FirebasePerformanceTraceExtension](#3-firebaseperformancetraceextension)
5. [FirebaseRemoteConfigManager](#4-firebaseremoteconfigmanager)
6. [통합 사용 시나리오](#통합-사용-시나리오)
7. [Firebase Console 확인 방법](#firebase-console-확인-방법)
8. [문제 해결](#문제-해결)
...
## 2. FirebaseCrashlyticsTraceDestination
...
- Non-fatal errors: error, fatal 레벨 로그 확인
- Issue 클릭 > Keys 탭: Breadcrumb 히스토리 확인
- 크래시 발생 직전 로그를 시간순으로 추적 가능
```
...
- TraceKit 공식 문서
- 프로젝트 통합 가이드: `FIREBASE_INTEGRATION.md`
...
이 모듈은 TraceKitDemo 프로젝트의 일부입니다.
